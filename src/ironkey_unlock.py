...
#
# THIRD-PARTY COMPONENT — not written by the IronKey Locker+ for Linux authors.
#
# Source : https://github.com/wltechblog/ironkey-unlocker
# Licence: GNU GPL 2.0
#
# Bundled unmodified so the application works out of the box. All copyright
# in this file belongs to its original authors. It provides the unlock
# protocol, the RSA-512 handshake and the USB/HID transport that this
